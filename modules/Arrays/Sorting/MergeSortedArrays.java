...
public class MergeSortedArrays {
    ...
    public static void mergeSortedArrays(int[] arr1, int[] arr2)
    {
        ...
        int maxValArr1 = ArrayUtils.getMaximum(arr1);
        int maxValArr2 = ArrayUtils.getMaximum(arr2);
        int maxVal = Math.max(maxValArr1, maxValArr2) + 1;
        ...
        while (i < m && j < n) {
            ...
            if (arr1[i] % maxVal < arr2[j] % maxVal) {
                arr[k] += (arr1[i] % maxVal) * maxVal;
                k++;
                i++;
            } else {
                arr[k] += (arr2[j] % maxVal) * maxVal;
                k++;
                j++;
            }
        }
